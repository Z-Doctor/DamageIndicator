...
public class RenderHelper {
	...
	public static void drawTexturedModalRect(double x, double y, double zLevel, double textureX, double textureY,
		...
		BufferBuilder bufferbuilder = tessellator.getBuffer();
		bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX);
		bufferbuilder.pos(x + 0, y + height, zLevel).tex(textureX * 0.0039062, (textureY + height) * 0.00390625F)
				.endVertex();
		bufferbuilder.pos(x + width, y + height, zLevel)
				.tex((textureX + width) * 0.00390625F, (textureY + height) * 0.00390625F).endVertex();
		bufferbuilder.pos(x + width, y + 0, zLevel).tex((textureX + width) * 0.00390625F, (textureY + 0) * 0.00390625F)
				.endVertex();
